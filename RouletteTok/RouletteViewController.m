...
- (void)initHandshake
{
    ...
    NSString *urlAsString = [NSString stringWithFormat:@"http://%@/socket.io/1?t=%.0f", serverUrl,time];
    ...
    [NSURLConnection
                         ...
                         NSError *error)
     {
         ...
         if ([data length] >0 && error == nil)
         {
             ...
             NSString* handshakeToken = [[response componentsSeparatedByString:@":"] objectAtIndex:0];
